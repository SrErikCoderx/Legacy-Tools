...
// 							spu_print("Render code missing for tile ID %d : render shape %d/n", tile->id, tile->getRenderShape());
// #endif
...
// 	spu_print("(%d,%d,%d) SPU num rendered : %d/n", m_x0+2, m_y0+2, m_z0+2,  numRenderedLayer0);
